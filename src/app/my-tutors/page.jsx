      ...
      <div className="page-wrapper">
        ...
        {tutors.length === 0 ? (
          <div className="empty-state">
            ...
            <p className="empty-subtitle">You have not added any tutor sessions yet.</p>
          </div>
        ) : (
              ...
              <table>
                ...
                <tbody>
                  {tutors.map((tutor, index) => {
                    ...
                    const modeClass =
                      mode === "online"
                        ? "mode-pill mode-online"
                        : mode === "offline"
                        ? "mode-pill mode-offline"
                        : "mode-pill mode-both";
                    ...
                    return (
                      <tr key={tutor._id}>
                        ...
                        {/* Tutor Name */}
                        <td>
                          <span className="tutor-name">{tutor.tutorName}</span>
                        </td>
                        ...
                        {/* Teaching Mode */}
                        <td>
                          <span className={modeClass}>{tutor.teachingMode}</span>
                        </td>

                        {/* Available Days */}
                        <td>
                          <span className="days-text">{tutor.availableDays}</span>
                        </td>

                        {/* Available Time */}
                        <td>
                          <span className="time-text">{tutor.availableTime}</span>
                        </td>

                        {/* Hourly Fee */}
                        <td>
                          <span className="fee-text">৳ {tutor.hourlyFee}</span>
                        </td>
                        ...
                        <td>
                          <span className="location-text">
                            <svg width="11" height="13" viewBox="0 0 11 13" fill="none">
                              <path
                                d="M5.5 0C3.01 0 1 2.01 1 4.5c0 3.37 4.5 8.5 4.5 8.5S10 7.87 10 4.5C10 2.01 7.99 0 5.5 0zm0 6.25A1.75 1.75 0 1 1 5.5 2.75a1.75 1.75 0 0 1 0 3.5z"
                                fill="#b0aec0"
                              />
                            </svg>
                            {tutor.location}
